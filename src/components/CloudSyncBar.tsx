  ...
  return (
    <>
          ...
          {user ? (
            <div className="flex items-center gap-2.5">
              ...
              <button
                ...
                disabled={loading}
                className="flex items-center gap-1 px-2.5 py-1 rounded-lg text-neutral-500 hover:text-apple-red dark:hover:text-apple-red hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-colors cursor-pointer"
                title="Sign Out"
              >
      ...
      <ConfirmModal
        ...
        description="Are you sure you want to sign out? Your offline workspace remains safe on this device."
